    ...
    public function run()
    {
        for($i = 1; $i <= 50; $i++){
            Post::create([
                ...
                src="http://localhost:8090/images/6088df79580c1.jpeg">&nbsp;<img style="width: 360px;" data-filename="post-img2.jpg" 
                src="http://localhost:8090/images/6088df79587b1.jpeg"></p><p style="font-family: Roboto, sans-serif; color: rgb(119, 119, 119); 

    ...
    <div class="card-body">
        <form action="{{ route('package.store') }}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('description2') is-invalid @enderror" name="description2" value="{{ old('description2') }}">
            </div>
            @error('description2')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
            <div class="form-group">
                <label for="">Description1 </label>
                <input type="text" class="form-control @error('description3') is-invalid @enderror" name="description3" value="{{ old('description3') }}">
            </div>
            @error('description3')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror

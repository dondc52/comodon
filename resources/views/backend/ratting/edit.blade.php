            ...
            <div class="row">
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('star_number') is-invalid @enderror" name="star_number" value="{{ $result->star_number }}">
                    </div>
                    @error('star_number')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('score') is-invalid @enderror" name="score" value="{{ $result->score }}">
                    </div>
                    @error('score')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror

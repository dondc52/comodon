    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ route('game.index') }}" class="nav-link {{request()->is('admin/game*') ? 'active' : ''}}">
                        <i class="nav-icon fas fa-gamepad"></i>
                        <p>Games</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('category.index') }}" class="nav-link {{request()->is('admin/categor*') ? 'active' : ''}}">
                        <i class="nav-icon fas fa-list"></i>
                        <p>Categories</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('gallery.index') }}" class="nav-link {{request()->is('admin/galler*') ? 'active' : ''}}">
                ...
                <li class="nav-item">
                    <a href="{{ route('package.index') }}" class="nav-link {{request()->is('admin/package*') ? 'active' : ''}}">
                        <i class="nav-icon fas fa-box-open"></i>
                        <p>Packages</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('ratting.index') }}" class="nav-link {{request()->is('admin/ratting*') ? 'active' : ''}}">
                ...
                <li class="nav-item">
                    <a href="{{ route('footer_link.index') }}" class="nav-link {{request()->is('admin/footer_link*') ? 'active' : ''}}">
